...
struct Current : Codable {
    ...
    // Gets the formatted current temperature
    var currentTemperature: String? {
        // Handle the case where temp_c is nil
        guard let temp = temp_c else {  return nil }
        let formattedTemperature = temp.formattedTemperature()
